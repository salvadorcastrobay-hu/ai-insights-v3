...
export type OrganicSynthesis = {
  ...
  best_performing: Array<{ post_id: string; likes: number; comments: number; caption_snippet: string }>;
...
const POST_COLS =
  ...
  "is_paid_partnership, display_url, recent_comments, analysis, fetched_at";
