...
type Props = {
  ...
  /** Botón temporal de debug ("Reintentar pendientes"), visible solo para mí. */
...
export function CompetitorAdsView({ ads, insights, refreshedAt, canRefresh, canRefreshWipSources = false, showRetryPending = false, readError, organicPosts = [], organicInsights = [], organicProfiles = [] }: Props) {
